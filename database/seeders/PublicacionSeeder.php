...
class PublicacionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $publicaciones = [
            ...
            [
                'titulo' => 'Adopción de loros mestizos',
                'descripcion' => 'Hermosos cachorros mestizos buscan un hogar cariñoso y responsable.',
                'raza' => 'Mestizo',
                'edad' => 2,
                'cantidad_machos' => 3,
            ...
            [
                'titulo' => 'gallinas',
                'descripcion' => 'Lindos gallisa de r una familia.',
                'raza' => 'Siames',
                'edad' => 3,
                'cantidad_machos' => 1,
                'cantidad_hembras' => 3,
            ...
            [
                'titulo' => 'conejo persas disponibles',
                'descripcion' => 'Gatitos de raza persa buscan un hogar tranquilo y amoroso.',
                'raza' => 'Persa',
                'edad' => 2,
                'cantidad_machos' => 2,
            ...
            //conejos
            [
                'titulo' => 'conejos verdea',
                'descripcion' => ' conejos, juguetones y cariñosos, disponibles para adopción.',
                'raza' => 'Golden Retriever',
                'edad' => 4,
                'cantidad_machos' => 2,
                'cantidad_hembras' => 1,
